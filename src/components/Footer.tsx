      ...
      <div class="max-w-5xl mx-auto relative z-10">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div class="text-center sm:text-left">
            ...
            <ul class="space-y-2">
              <li>
                <a href="#about" class="text-white/60 hover:text-white transition-colors text-xs sm:text-sm">
                  About
                </a>
              </li>
              <li>
                <a href="#features" class="text-white/60 hover:text-white transition-colors text-xs sm:text-sm">
                  Features
                </a>
              </li>
              <li>
                <a href="#documentation" class="text-white/60 hover:text-white transition-colors text-xs sm:text-sm">
                  Docs
                </a>
              </li>
            </ul>
          ...
          <div class="text-center sm:text-left">
            ...
            <ul class="space-y-2">
              <li>
                <a href="#" class="text-white/60 hover:text-white transition-colors text-xs sm:text-sm">
                  Developer Docs
                </a>
              </li>
              <li>
          ...
          <div class="text-center sm:text-left">
            ...
            <div class="flex gap-3 sm:gap-4 justify-center sm:justify-start">
              ...
              >
                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 448 512">
              ...
              <a
                ...
                aria-label="Facebook"
              >
                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 320 512">
              ...
              <a
                ...
                aria-label="YouTube"
              >
                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 576 512">
        ...
        <div class="border-t border-white/10 mb-4 sm:mb-6"></div>

        <div class="text-center">
          <p class="text-white/40 text-xs sm:text-sm">
            &copy; 2025 CROW Inc. | All Rights Reserved
          </p>
        </div>
      </div>
    </footer>
